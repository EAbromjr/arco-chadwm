...
static const int horizpadbar = 3; /* padding inside the bar */
...
// "Vb", "Mail", "Video", "Image", "Files", "Music" }; static char *tags[] =
// {"一", "二", "三", "四", "五", "六", "七", "八", "九", "十"};
...
static const Launcher launchers[] = {
    ...
    {discord, "ﱲ"},    {firefox, ""},    {thorium, ""},  {eww, "數"},
    {mintstick, "虜"}, {pavucontrol, "墳"}, {telegram, ""}, {vivaldi, ""},
};
